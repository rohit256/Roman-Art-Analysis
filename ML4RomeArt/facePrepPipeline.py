...
if __name__ == '__main__':
    ...
    outputDir = os.path.join(faces_folder_path,'Applying_face-extractor')
    ...
    for f in glob.glob(os.path.join(faces_folder_path, "*.jpg")):
        ...
        if FILTER_MODE == 1:
            ...
            if k == 49:
                print('good',imName)
                print(imName,file=goodList)
        print (imName+" "+str(d.left())+str(d.top())+str(d.right())+str(d.bottom())+str(landmarks),file=filterListFile)
